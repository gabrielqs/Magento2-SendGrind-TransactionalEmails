...
namespace Gabrielqs\TransactionalEmails\Test\Unit\Controller\Adminhtml\Customer;
...
use \Gabrielqs\TransactionalEmails\Controller\Adminhtml\Customer\Index as Subject;
...
class IndexTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testExecute()
    {
        ...
        $this
            ...
            ->expects($this->once())
            ->method('register')
            ->with(RegistryConstants::CURRENT_CUSTOMER_ID, $id);
        $this
            ->resultLayoutFactory
            ->expects($this->once())
            ->method('create')
