...
namespace Gabrielqs\TransactionalEmails\Block\Adminhtml\Order\View\Tab\TransactionalEmails;
...
class Grid extends Extended
{
    ...
    /**
     * Retrieves current order id from registry
     * @return int
     */
    protected function _getOrderId()
    {
        return $this->_coreRegistry->registry(RegistryConstants::CURRENT_ORDER_ID);
    }
    ...
    protected function _prepareCollection()
    {
        $searchCriteria = $this
            ...
            ->addFilter(Email::ORDER_ID, $this->_getOrderId(), 'eq')
            ->create();
